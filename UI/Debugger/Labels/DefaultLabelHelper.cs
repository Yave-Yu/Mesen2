...
namespace Mesen.Debugger.Labels
{
	public class DefaultLabelHelper
	{
		...
		private static void SetWsDefaultLabels()
		{
			...
			addLabel(0xC1, 1, "WS_CART_BANK_RAM_PORT", "RAM (0x10000 - 0x1FFFF) bank address (up to 16 MB).");
			addLabel(0xC2, 1, "WS_CART_BANK_ROM0_PORT", "ROM0 (0x20000 - 0x2FFFF) bank address (up to 16 MB).");
			addLabel(0xC3, 1, "WS_CART_BANK_ROM1_PORT", "ROM1 (0x30000 - 0x3FFFF) bank address (up to 16 MB).");
			...
			addLabel(0xD0, 2, "WS_CART_EXTBANK_RAM_PORT", "RAM (0x10000 - 0x1FFFF) bank address (up to 4 GB).");
			addLabel(0xD2, 2, "WS_CART_EXTBANK_ROM0_PORT", "ROM0 (0x20000 - 0x2FFFF) bank address (up to 4 GB).");
			addLabel(0xD4, 2, "WS_CART_EXTBANK_ROM1_PORT", "ROM1 (0x30000 - 0x3FFFF) bank address (up to 4 GB).");
